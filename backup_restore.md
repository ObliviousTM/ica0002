...
To restore the tables in Grafana, please run the following command from machine `ObliviousTM-3` as `backup` user.

```
duplicity --no-encryption restore rsync://ObliviousTM@backup.rdash.io//home/ObliviousTM/ /home/backup/restore/
```
